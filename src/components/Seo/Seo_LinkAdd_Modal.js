...
const Seo_LinkAdd_Modal = Form.create()(
  (props) => {
    ...
    return (
      ...
      >
        <Form>
          <FormItem {...formItemLayout} label="链接名称">
          ...
          <FormItem {...formItemLayout_radio} label="上传图标" className="collection-create-form_last-form-item">
            {getFieldDecorator('modifier')(
              <Upload_Image />
            )}
          </FormItem>           
...
export default Seo_LinkAdd_Modal;